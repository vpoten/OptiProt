 ...
 * @author victor
 */
public class RotamerMutationOperatorTest {

    public RotamerMutationOperatorTest() {
    }
    ...
    /**
     * Test of operate method, of class RotamerMutationOperator.
     */
    @Test
    public void testOperate() throws InvalidConfigurationException, StructureException {
        System.out.println("RotamerMutationOperator.operate");
        ...
        RotamerMutationOperator instance = new RotamerMutationOperator(conf, 1);
